...
1.	Utilisez une vue partiel pour regrouper le bouton d'action et le bouton de retour vers la liste. Utilisez cette vue partielle pour les actions suivantes:
    - Create
    - Save
    - Delete
...
:::caution
   ...
   Il faut utiliser cette vue partielle pour les pages de **Trainer** et **Speciality**
